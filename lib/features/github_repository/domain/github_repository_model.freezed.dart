...
/// @nodoc
@JsonSerializable()
class _$GitHubRepositoryModelImpl implements _GitHubRepositoryModel {
  const _$GitHubRepositoryModelImpl({required this.id, required this.name});
  ...
  @override
  String toString() {
    return 'GitHubRepositoryModel(id: $id, name: $name)';
  }
...
abstract class _GitHubRepositoryModel implements GitHubRepositoryModel {
  const factory _GitHubRepositoryModel(
      ...
      required final String name}) = _$GitHubRepositoryModelImpl;
